...
<div class="content">
    ...
    <form action="{{route('update.adminblog', ['id' => $MasterBlog->id])}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="">
            ...
            <br>
            <div id="dropZ">
                <img class="panel-img-top" src="/storage/blog/{{$MasterBlog->id}}/{{$MasterBlog->cover_img}}" alt="Card image cap" width="200px" id="cover_img">
                <br>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="from-group autocomplete">
                            @if($category)
                                <input id="category" class="form-control" type="text" name="category" placeholder="Category" value="{{$category->category}}">
                            @else
                ...
                <!-- include('Layouts.category_checkbox_list') -->
            </div>
        </div>
