...
@section('title', 'Blog Create Portfolio')
@section('custom-css')
<style>
...
<div class="content">
    ...
    <form action="{{route('store.adminportfolio')}}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="form-group">
            <label for="title">Title:</label>
            <input type="text" name="project_name" class="form-control" placeholder="Title">
        </div>
        <div class="form-group">
